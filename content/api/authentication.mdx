...
```bash
curl https://api.boooply.com/api/integration/interviews \
...
- Get your API key from the [Boooply Integrations page](https://boooply.com/integrations) under **REST API & SDK**
